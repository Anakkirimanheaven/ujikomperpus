                    ...
                    <div class="card-body">
                        <form class="row" method="POST" action="{{ route('peminjaman.store') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control mb-3" type="date" name="tgl_pinjam"
                                    value="{{ $sekarang }}" required>
                            </div>

                            <div class="col-md-6">
                                <label for="input13" class="form-label">Jatuh Tempo</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control mb-3" type="date" name="tgl_kembali" required>
                            </div>

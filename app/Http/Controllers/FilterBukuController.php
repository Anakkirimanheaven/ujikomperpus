...
class FilterBukuController extends Controller
{
    public function filterkategori($id = null)
    {
        ...
        return view('user.buku', compact('penerbit', 'penulis', 'user', 'peminjaman', 'buku', 'kategori'));
    }
    ...
    public function filterpenerbit($id = null)
    {
        ...
        return view('user.buku', compact('kategori', 'penerbit', 'penulis', 'user', 'peminjaman', 'buku'));
    }

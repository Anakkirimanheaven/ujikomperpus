        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control mb-3" type="date" name="tgl_pinjam" value="{{ $peminjaman->tgl_pinjam }}" readonly>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Loan deadline</label>
                    <input class="form-control mb-3" type="date" name="batas_tanggal" value="{{ $peminjaman->batas_tanggal }}" readonly>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Return date</label>
                    <input class="form-control mb-3" type="date" name="tgl_kembali" value="{{ $peminjaman->tgl_kembali }}" readonly>
                </div>

                <div class="col-md-6">
                    <label for="input13" class="form-label">Amount</label>
                    <div class="position-relative">
                        <input class="form-control mb-3" type="number" name="jumlah" placeholder="Jumlah" value="{{$peminjaman->jumlah}}" required>
                    </div>
                </div>

                <div class="col-md-12">
                    <label for="input13" class="form-label">Reason for rejection</label>
                    <textarea class="form-control mb-3" id="reasonTextarea" type="text" name="alasan" readonly>{{ $peminjaman->alasan }}</textarea>
                </div>
